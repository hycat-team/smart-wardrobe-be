...
func InitializeApp(cfg *config.Config, l logger.Interface) (*bootstrap.App, func(), error) {
	...
	brandPortalHandler := handler4.NewBrandPortalHandler(iBrandCoreUseCase)
	brandLoyaltyHandler := handler4.NewBrandLoyaltyHandler(iBrandCoreUseCase)
	brandChatHandler := handler4.NewBrandChatHandler(iBrandCoreUseCase)
