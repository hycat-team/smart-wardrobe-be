...
import (
	...
	usecase_interfaces "smart-wardrobe-be/internal/modules/fashion/application/interface/usecase"
...
// @Description - details (Ghi chú thêm bằng tay, tối đa 1.000 ký tự Unicode sau khi chuẩn hóa NFC. Frontend nên kiểm tra giới hạn trước khi gửi để đảm bảo trải nghiệm người dùng.)
// @Tags Wardrobe AI
// @Accept json
// @Produce json
...
// @Description Nội dung tin nhắn được giới hạn tối đa 2.000 ký tự Unicode sau khi chuẩn hóa NFC. Frontend nên kiểm tra giới hạn trước khi gửi để đảm bảo trải nghiệm người dùng.
