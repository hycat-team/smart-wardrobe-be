...
*   **Các giá trị hợp lệ:**
    ...
    *   `manager`: Quản lý nhãn hàng (tạo chiến dịch, sản phẩm, quản lý loyalty).
    *   `support_staff`: Nhân viên hỗ trợ (tích điểm offline, chat hỗ trợ).
    *   `marketer`: Nhân viên truyền thông.
